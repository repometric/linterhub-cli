...
dotnet bin/publish/metrics.integrations.linters.cli.dll --config config.MacOS.json --linter htmlhint --project /Volumes/Repositories/EPAM/ggrc-core-fork | dotnet bin/publish/metrics.integrations.linters.cli.dll io