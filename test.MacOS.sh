...
#dotnet bin/publish/metrics.integrations.linters.cli.dll --config config.MacOS.json --linter htmlhint --project /Volumes/Repositories/ggrc-core-fork | dotnet bin/publish/metrics.integrations.linters.cli.dll io